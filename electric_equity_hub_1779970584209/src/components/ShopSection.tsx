    ...
    return (
      <section id="shop" className="py-24">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <div className="bg-card rounded-3xl border border-white/10 p-8 mb-6">
            <button 
              onClick={() => { setShowCheckout(false); window.scrollTo({ top: 0, behavior: 'smooth' }); }} 
              className="w-full border-2 border-[#d4af37] text-[#d4af37] py-3 rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-[#d4af37] hover:text-white transition"
            >
              + Add More Products
            </button>
          </div>
